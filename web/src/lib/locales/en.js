...
export const en = {
	...
	'notif.projectShared': '{name} shared a project with you',
	...
	'notes.sharedWithFollowers': 'Shared with {name} — along with the {count} notes it points at.',
	'notes.shareFollows': 'Comes along:',
	'notes.shareVia': 'came along with “{note}”',
	'notes.unsharedPerson': '{name} can no longer see the note.',
	// Sharing with an address. The words have to carry both outcomes — a share now,
	// or an invitation that waits — without promising either one.
	'notes.shareByEmail': 'Share with an email address',
	'notes.shareEmailPlaceholder': 'name@example.com',
	'notes.shareRole': 'Role',
	'notes.shareInvite': 'Invite',
	'notes.invited': 'The invitation has been sent to {email}.',
	'notes.invitePending': 'invited',
	...
	'ai.askThis': 'Ask about this',
	'ai.askSources': 'From:',
	'ai.askNothing': 'There is nothing in your notes or tasks that answers that.',
	'ai.plan': "Today's plan",
	'ai.planHint':
	...
	'notes.imageTitle': 'Image',
	'notes.imageCopy': 'Copy the image',
	'notes.imageCopied': 'Copied',
	'notes.imageOpen': 'Open in a new tab',
	...
	'project.pickPerson': 'Pick somebody…',
	'project.leave': 'Leave the project',
	'project.leaveSure': 'Leave {name}? You lose access, and only its owner can let you back in.',
	'project.roleForPicked': 'Role for the person picked',
	'project.shareWith': 'Share',
	'project.orByEmail': 'Or somebody who is not here yet:',
	'project.invited': 'Invited, not arrived yet',
	'project.withdrawInvite': 'Withdraw the invitation to {email}',
